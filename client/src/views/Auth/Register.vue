        ...
        <div class="overlay-container">
          <div class="overlay">
            <div class="overlay-panel overlay-left">
              ...
              <p>Создайте аккаунт, используя свои персональные данные и используйте весь функционал сайта!</p>
              <button class="ghost" @click="$router.push('/login')">Войти</button>
            </div>
          </div>
        </div>
...
.overlay {
  background: #ec0838;
  background: linear-gradient(to right, #FF4B2B, #b6002a);
